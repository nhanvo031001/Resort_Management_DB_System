<template>
  <div>
    ...
    <table class="table table-striped list-book">
            ...
            <tbody>
                <tr v-for="item in resultQuery" :key="item.ma_loai_phong" v-on:orderchanged="getList()">
                    ...
                    <router-link active-class="active" exact class="side-btn-new" :to="{name: 'loaiPhongInfo', params: {loaiPhongID: item.ma_loai_phong}}"> 
