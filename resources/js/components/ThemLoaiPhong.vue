<template>
    <div>
        ...
        <div class="container filling-all-info">
            ...
            <div class="row one-row-field">
                <div class="col-3 text-left field-name-left">Thêm vật tư<span class="red-star">*</span> </div>
            </div>
            ...
            <table class="table table-borderless  list-book">
                ...
                <tbody>
                    <tr v-for="item in tempArr" :key="item.ma_loai_vat_tu">
                        <td ></td>
                        <td class="item-ten-vat-tu">{{item.ten_loai_vat_tu}} </td>
                        <!-- <td > <input class="vat-tu-input" type="text" v-model="item.so_luong"> </td> -->
                        <td >
                            <div class="amount">
                                <svg v-on:click="changeAmount(item.ma_loai_vat_tu, 1)" xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="currentColor" class="bi bi-plus-square plus" viewBox="0 0 16 16">
                                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                </svg>

                                <input class="so-luong-vat-tu" type="text" v-model="item.so_luong" size="10">

                                <svg v-on:click="changeAmount(item.ma_loai_vat_tu, -1)" xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="currentColor" class="bi bi-dash-square minus" viewBox="0 0 16 16">
                                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
            ...
            <div class="row one-row-field">
                <div class="col-4 text-left field-name-left">Thêm thông tin giường<span class="red-star">*</span> </div>
            </div>
            <div class="row one-row-field">
                <div class="col-3 text-left field-name-left">Kích thước<span class="red-star">*</span> </div>
                <div class="col text-left"><input class="row-input" v-model="kichThuoc" type="text" size="80"></div>
            </div>
            <div class="row one-row-field">
                <div class="col-3 text-left field-name-left">Số lượng<span class="red-star">*</span> </div>
                <div class="col text-left"><input class="row-input" v-model="soLuong" type="text" size="80"></div>
            </div>
            ...
            <div class="row button-below-them">
                ...
                <div class="col text-right">
                    ...
                    <div class="giuong-vat-tu">
                        ...
                        <button v-on:click="themGiuong" type="button" class="btn btn-primary giuong">Thêm giường</button>
...
export default {
    ...
    methods: {
        ...
        themGiuong() {
            this.giuongArr.push({kichThuoc: this.kichThuoc, soLuong: this.soLuong})
        ...
        createRoom() {
            ...
            dien_tich: this.loaiPhong.dien_tich, so_khach: this.loaiPhong.so_khach, mo_ta_khac: this.loaiPhong.mo_ta_khac, vatTu: this.vatTuArr,
